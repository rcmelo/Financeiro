...
layout = dbc.Col([
                ...
                html.P("By Renan", className="text-info"),
                html.Hr(),
...
# Sessão NOVO -----------+ 
                ...
                # Modal Receita
                dbc.Modal([
                    dbc.ModalHeader(dbc.ModalTitle('Adicinar receita')),
                    dbc.ModalBody([
                        dbc.Row([
                            dbc.Col([
                                dbc.Label('Descrição: '),
                ...
                dbc.Modal([
                    dbc.ModalHeader(dbc.ModalTitle('Adicinar Despesa')),
                    dbc.ModalBody([
                        dbc.Row([
                            dbc.Col([
                                dbc.Label('Descrição: '),
                        ...
                        dbc.Row([
                            ...
                            dbc.Col([
                                html.Label('Categoria da despesas'),
                    ...
                    dbc.Row([
                        ...
                        dbc.ModalFooter([
                            dbc.Button("Adicionar Despesas", id="salvar_despesa", color="success"),
                            dbc.Popover(dbc.PopoverBody("Despesas Salva"), target="salvar_despesa", placement="left", trigger="click"),
                        ])
                    ], style={'margin-top': '25px'})
            ])                
